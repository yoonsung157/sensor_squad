...
CREATE TABLE `tb_notice` (
  ...
  `author_id` int NOT NULL COMMENT '작성자(관리자) ID',
  `title` varchar(200) NOT NULL COMMENT '공지사항 제목',
  `content` text NOT NULL COMMENT '공지사항 내용',
  `view_count` int DEFAULT '0' COMMENT '조회수',
  `importance` tinyint(1) DEFAULT '0' COMMENT '중요 공지 여부 (1: 중요, 0: 일반)',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`notice_id`),
  KEY `author_id` (`author_id`),
  CONSTRAINT `tb_notice_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `tb_user` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_user` VALUES (1,'admin_01','password123!','홍길동','ADMIN','2026-03-07 06:28:34');
...
-- Dump completed on 2026-03-10  4:37:01
